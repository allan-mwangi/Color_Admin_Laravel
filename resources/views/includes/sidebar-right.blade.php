		...
		<div class="p-20px text-body">
			...
			<div class="d-flex align-items-center">
				<div class="position-relative d-flex w-35px h-35px">
					<input class="knob" data-width="35" data-height="35" data-thickness=".2" data-readonly="true" data-min="10" data-displayInput="false" value="44" data-fgColor="#00acac" data-bgColor="rgba(0,0,0,0.5)" />
				</div>
			...
			<div class="d-flex align-items-center">
				<div class="position-relative d-flex w-35px h-35px">
					<input class="knob" data-width="35" data-height="35" data-thickness=".2" data-readonly="true" data-min="10" data-displayInput="false" value="67" data-fgColor="#348fe2" data-bgColor="rgba(0,0,0,0.5)" />
				</div>
				<div class="flex-grow-1 ps-3">
			...
			<div class="d-flex align-items-center">
				<div class="position-relative d-flex w-35px h-35px">
					<input class="knob" data-width="35" data-height="35" data-thickness=".2" data-readonly="true" data-min="10" data-displayInput="false" value="70" data-fgColor="#ff5b57" data-bgColor="rgba(0,0,0,0.5)" />
				</div>
				<div class="flex-grow-1 ps-3">
			...
			<div class="d-flex align-items-center">
				<div class="position-relative d-flex w-35px h-35px">
					<input class="knob" data-width="35" data-height="35" data-thickness=".2" data-readonly="true" data-min="10" data-displayInput="false" value="52" data-fgColor="#727cb6" data-bgColor="rgba(0,0,0,0.5)" />
				</div>
				<div class="flex-grow-1 ps-3">
			...
			<div class="accordion" id="accordionExample">
				<div class="accordion-item panel panel-inverse mb-0 rounded-0 rounded-top overflow-hidden">
					...
					<div id="collapseOne" class="accordion-collapse collapse show border-0" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
						<div class="accordion-body panel-body text-body  bg-gray-700">
